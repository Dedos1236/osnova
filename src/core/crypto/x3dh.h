...
/**
 * @brief Extended Triple Diffie-Hellman (X3DH) Protocol.
 * Used for authenticated key agreement in the OSNOVA handshake.
 */
class X3dh {
public:
    static constexpr size_t SHARED_SECRET_SIZE = 32;
    static constexpr size_t PREKEY_MESSAGE_SIZE = 32 /* IK_A */ + 32 /* EK_A */ + 32 /* IK_B_ID */ + 32 /* SPK_B_ID */ + 32 /* OPK_B_ID */;
    ...
    static bool initiate(
        ...
        std::span<const uint8_t> OPK_B_pub, // Optional, can be empty
    ...
    static bool respond(
        ...
        std::span<const uint8_t> OPK_B_priv, // Optional, can be empty
